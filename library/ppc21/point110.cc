...
Point::Point(Geometry::Cartesian::X x, Geometry::Cartesian::Y y) : Point(x.mValue, y.mValue)
{
}

Point::Point(Geometry::Polar::Radius r, Geometry::Polar::Angle phi) : Point(r.mValue * std::cos(phi.mRadiant), r.mValue * std::sin(phi.mRadiant))
{
}
...
SIMPLETEST("Point ctor2") {
    Point p{Geometry::Cartesian::X{1.0}, Geometry::Cartesian::Y{2.0}};
...
SIMPLETEST("Point ctor3") {
    Point p{Geometry::Cartesian::X{1.0}};
...
SIMPLETEST("Point toSVG2") {
    Point p = {Geometry::Cartesian::X{1.1}, Geometry::Cartesian::Y{2.9}};
    p.color("red");
...
SIMPLETEST("Point distance") {
    Point p1;
    Point p2 = {Geometry::Cartesian::X{1.0}, Geometry::Cartesian::Y{1.0}};
...
SIMPLETEST("Point ctor4") {
    Point p = {Geometry::Polar::Radius{1.0}, Geometry::Polar::Angle{0.0}};
...
SIMPLETEST("Point ctor5") {
    Point p = {Geometry::Polar::Radius{1.0}, Geometry::Polar::Angle{Math::pi() / 2.0}};
...
SIMPLETEST("Point assignment") {
    Point p1 = {Geometry::Polar::Radius{1.0}, Geometry::Polar::Angle{Math::pi() / 2.0}};
    p1.color("red");
