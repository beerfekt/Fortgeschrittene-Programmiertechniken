...
public:
    ...
    //]
    PointList(PointList&& other); // <> Besondere Signatur des _Verschiebungskonstruktors_: `<type>&&` ist eine sog. _rvalue_-Referenz
    PointList& operator=(PointList&& rhs); // <> Besondere Signatur des _Verschiebungszuweisungsoperators_ (wie oben)
    //[a
