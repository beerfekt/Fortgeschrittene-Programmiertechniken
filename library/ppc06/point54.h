...
public:
    ...
    //]
    Point& operator=(const Point& rhs); // <> Deklaration des *Kopierzuweisungsoperators*
    //[a
    double getX() const;
    double getY() const;
...
private:
    ...
    //]
    const int mSNR; // <> Dieses `const`-Datenelement verhindert die Synthetisierung des _Kopierzuweisungsoperators_
    //[a
